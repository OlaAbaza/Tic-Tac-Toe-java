...
public class LoginPane extends Pane {
    ...
    public LoginPane() {
        ...
        audio = new AudioClip(getClass().getResource("/sounds/AfricanSafariLoop.wav").toExternalForm());
        ...
        LogInBtn.setOnMouseClicked((event) -> {
            ...
            sleeper.setOnSucceeded(new EventHandler<WorkerStateEvent>() {
                ...
                public void handle(WorkerStateEvent event) {
                    String msg = login();
                    if (msg.equals("you loged in")) {
                        AppManager.playerName = UserNameInput.getText();
                        //AppManager.refresh();
