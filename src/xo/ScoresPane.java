...
public class ScoresPane extends Pane {
    ...
    public ScoresPane() {
        ...
        for (int i = 0; i < opponent.size() && i < PlayerOneScore.size() && i < PlayerTwoScore.size(); i++) {
            scoreTable.getItems().add(new Score(opponent.get(i), PlayerOneScore.get(i), PlayerTwoScore.get(i)));
        }
